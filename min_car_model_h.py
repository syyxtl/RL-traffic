...
if __name__ == '__main__':
    ...
    for idx in range(287):
        ...
        if idx != 0:    
            for _Dstate in Drivers:
                ...
                if np.sum(ACTION) == 0:
                    ...
                    Outputs = ACTION * 1.0 / np.sum(ACTION) * np.array(vo) * 10 #
                    # print(Outputs)
        ...
        if idx >= 2:
            ...
            P += ( int(total_cost) + 0) * 1.0 / lend
            D += ( int(total_dist) + 0) * 1.0 / int(total_cost)
            print(total_cost, lend, total_dist, "percent:", ( int(total_cost) + 0) * 1.0 / lend, "distance:", ( int(total_dist) + 0) * 1.0 / int(total_cost))
